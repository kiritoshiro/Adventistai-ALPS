  ...
  <div class="c-search-drawer__filter c-filter c-filter-is-active">
    ...
    @else
      <form action="<?php echo esc_url(home_url('/')); ?>" role="search" method="get" class="search-form c-filter__search">
        <fieldset>
          <input type="search" value="{{ the_search_query() }}" name="s" placeholder="Ieškoti..." class="search-form__input u-font--secondary--s u-theme--color--darker can-be--white" required />
