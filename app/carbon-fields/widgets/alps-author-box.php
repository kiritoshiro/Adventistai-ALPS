<div class="c-block c-block__text has-image u-padding--zero--left u-clear-fix">
  <?php if (function_exists('get_avatar_url')): ?>
    <img class="c-block__image" itemprop="image" src="<?php echo esc_url(get_avatar_url(get_the_author_meta('email'), array("size" => 400))); ?>">
  <?php endif; ?>
  ...
  <ul class="o-inline-list">
    <?php if (get_the_author_meta('url') != ''): ?>
      <li>
        <a class="author-link t" title="View Website" href="<?php echo esc_url(get_the_author_meta('url')); ?>" target="_blank" rel="noopener noreferrer">
    ...
    <?php if (get_the_author_meta('facebook') != ''): ?>
      <li>
        <a class="author-link" title="Follow on Facebook" href="<?php echo esc_url(get_the_author_meta('facebook')); ?>" target="_blank" rel="noopener noreferrer">
    ...
    <?php if (get_the_author_meta('twitter') != ''): ?>
      <li>
        <a class="author-link" title="Follow on Twitter" href="<?php echo esc_url('https://twitter.com/' . rawurlencode((string) get_the_author_meta('twitter'))); ?>" target="_blank" rel="noopener noreferrer">
          <span class="u-icon u-icon--m u-path-fill--gray">
