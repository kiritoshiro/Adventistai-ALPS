<div class="c-block c-block__text has-image u-padding--zero--left u-clear-fix">
  <?php if (function_exists('get_avatar_url')): ?>
    <img class="c-block__image" itemprop="image" src="<?php echo esc_url(get_avatar_url(get_the_author_meta('email'), array('size' => 400))); ?>" alt="<?php echo esc_attr(get_the_author_meta('display_name')); ?>">
  <?php endif; ?>
  <h4 class="c-media-block__kicker c-block__kicker u-space--zero--top">
    <?php echo esc_html($settings['text_link_title'] ?? ''); ?>
  </h4>
  ...
  <ul class="o-inline-list">
    <?php if (get_the_author_meta('url') !== ''): ?>
      <li>
        <a class="author-link t" title="<?php echo esc_attr__('View Website', 'alps'); ?>" href="<?php echo esc_url(get_the_author_meta('url')); ?>" target="_blank" rel="noopener noreferrer">
          ...
          <?php esc_html_e('Website', 'alps'); ?>
        </a>
      </li>
    <?php endif; ?>
    <?php if (get_the_author_meta('facebook') !== ''): ?>
      <li>
        <a class="author-link" title="<?php echo esc_attr__('Follow on Facebook', 'alps'); ?>" href="<?php echo esc_url(get_the_author_meta('facebook')); ?>" target="_blank" rel="noopener noreferrer">
          ...
          <?php esc_html_e('Facebook', 'alps'); ?>
        </a>
      </li>
    <?php endif; ?>
    <?php if (get_the_author_meta('twitter') !== ''): ?>
      <li>
        <a class="author-link" title="<?php echo esc_attr__('Follow on Twitter', 'alps'); ?>" href="<?php echo esc_url('https://twitter.com/' . ltrim((string) get_the_author_meta('twitter'), '@')); ?>" target="_blank" rel="noopener noreferrer">
          <span class="u-icon u-icon--m u-path-fill--gray">
